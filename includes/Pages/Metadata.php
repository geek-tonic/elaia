...
$domain  = Elaia\Pages\ElaiaPagesMethods::detect_domain();
$referer = Elaia\Pages\ElaiaPagesMethods::detect_referer();
...
include_once plugin_dir_path(__FILE__) . 'views/metadata.php';
