...
<style>
  ...
  .em-map-popup-btn { display: inline-flex; align-items: center; gap: 4px; font-size: 12px; font-weight: 600; color: <?php echo $primaryColor; ?>; cursor: pointer; background: none; border: none; padding: 0; font-family: inherit; }
  ...
  .em-filter-check input[type="checkbox"] { cursor: pointer; accent-color: <?php echo $primaryColor; ?>; width: 15px; height: 15px; }
  ...
  /* Pied de card */
  .em-card-footer { padding-top: 10px; border-top: 1px solid #e2e8f0; display: flex; align-items: center; gap: 4px; font-size: 12px; font-weight: 600; color: <?php echo $primaryColor; ?>; }
  ...
  .em-modal-link { display: inline-flex; align-items: center; gap: 6px; font-size: 14px; font-weight: 600; color: <?php echo $primaryColor; ?>; text-decoration: none; }
...
$excludedKeys = [
  'name', 'image', 'images', 'link', 'image_url',
  'latitude', 'longitude', 'gps_coordinates_latitude', 'gps_coordinates_longitude',
  'latitude_deg', 'longitude_deg', 'description', 'desciption',
  'comment', 'address', 'available_image_urls', 'site_officiel',
];
          ...
          <article class="em-card"
            ...
            <div class="em-card-body">
              ...
              <div class="em-card-tags">
                <?php $tagCount = 0; foreach ($tagFields as $tagKey => $tagConfig):
                  if ($tagCount >= 4) break;
              ...
              <div class="em-card-fields">
                <?php $fieldCount = 0; foreach ($itemData as $fieldKey => $fieldValue):
                  ...
                  if ($fieldCount >= 3) break; $fieldCount++;
                ?>
