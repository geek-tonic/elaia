...
<head>
  ...
  <title><?php echo esc_html(get_bloginfo('name')); ?> — Découvertes</title>
...
<body>
  ...
  <div class="elaia-header">
    <h1>✨ Découvertes autour de vous</h1>
    <p>Hébergements, villes, activités et événements à proximité</p>
  </div>
